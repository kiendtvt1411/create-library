...
public class IndicatorView extends ViewPager implements IndicatorInterface,
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        this.radiusSelected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_nkien_selected_radius,
                DEFAULT_RADIUS_SELECTED);

        this.radiusUnselected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_nkien_unselected_radius,
                DEFAULT_RADIUS_UNSELECTED);

        this.distance = typedArray.getInt(R.styleable.IndicatorView_nkien_distance,
                DEFAULT_DISTANCE);

        this.colorSelected = typedArray.getInt(R.styleable.IndicatorView_nkien_selected_color,
                Color.parseColor("#ffffff"));

        this.colorUnselected = typedArray.getInt(R.styleable.IndicatorView_nkien_unselected_color,
                Color.parseColor("#ffffff"));
    ...
    private void initDot(int count) throws PageLessException {
